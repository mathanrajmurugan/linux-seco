...
typedef struct MLAN_PACK_START _ExtCap_t {
    /** Extended Capabilities value */
	t_u16 BSS_CoexistSupport:1;	/* bit 0 */
	t_u16 Reserved1:1;	/* bit 1 */
	t_u16 ExtChanSwitching:1;	/* bit 2 */
	t_u16 RejectUnadmFrame:1;	/* bit 3 */
	t_u16 PSMP_Capable:1;	/* bit 4 */
	t_u16 Reserved5:1;	/* bit 5 */
	t_u16 SPSMP_Support:1;	/* bit 6 */
	t_u16 Event:1;		/* bit 7  */
	t_u16 Diagnostics:1;	/* bit 8  */
	t_u16 MulticastDiagnostics:1;	/* bit 9  */
	t_u16 LocationTracking:1;	/* bit 10 */
	t_u16 FMS:1;		/* bit 11 */
	t_u16 ProxyARPService:1;	/* bit 12 */
	t_u16 CollocatedIntf:1;	/* bit 13 */
	t_u16 CivicLocation:1;	/* bit 14 */
	t_u16 GeospatialLocation:1;	/* bit 15 */
	t_u16 TFS:1;		/* bit 16 */
	t_u16 WNM_Sleep:1;	/* bit 17 */
	t_u16 TIM_Broadcast:1;	/* bit 18 */
	t_u16 BSS_Transition:1;	/* bit 19 */
	t_u16 QoSTrafficCap:1;	/* bit 20 */
	t_u16 AC_StationCount:1;	/* bit 21 */
	t_u16 MultipleBSSID:1;	/* bit 22 */
	t_u16 TimingMeasurement:1;	/* bit 23 */
	t_u16 ChannelUsage:1;	/* bit 24 */
	t_u16 SSID_List:1;	/* bit 25 */
	t_u16 DMS:1;		/* bit 26 */
	t_u16 UTC:1;		/* bit 27 */
	t_u16 TDLSPeerUAPSDSupport:1;	/* bit 28 */
	t_u16 TDLSPeerPSMSupport:1;	/* bit 29 */
	t_u16 TDLSChannelSwitching:1;	/* bit 30 */
	t_u16 Interworking:1;	/* bit 31 */
	t_u16 Qos_Map:1;		/* bit 32 */
	t_u16 EBR:1;		/* bit 33 */
	t_u16 SSPN_Interface:1;	/* bit 34 */
	t_u16 Reserved35:1;	/* bit 35 */
	t_u16 MSGCF_Capa:1;	/* bit 36 */
	t_u16 TDLSSupport:1;	/* bit 37 */
	t_u16 TDLSProhibited:1;	/* bit 38 */
	t_u16 TDLSChlSwitchProhib:1;	/* bit 39 */
	t_u16 rsvdBit40:1;	/* bit 40 */
	t_u16 rsvdBit41:1;	/* bit 41 */
	t_u16 rsvdBit42:1;	/* bit 42 */
	t_u16 rsvdBit43:1;	/* bit 43 */
	t_u16 rsvdBit44:1;	/* bit 44 */
	t_u16 rsvdBit45:1;	/* bit 45 */
	t_u16 rsvdBit46:1;	/* bit 46 */
	t_u16 rsvdBit47:1;	/* bit 47 */
	t_u16 rsvdBit48:1;	/* bit 48 */
	t_u16 rsvdBit49:1;	/* bit 49 */
	t_u16 rsvdBit50:1;	/* bit 50 */
	t_u16 rsvdBit51:1;	/* bit 51 */
	t_u16 rsvdBit52:1;	/* bit 52 */
	t_u16 rsvdBit53:1;	/* bit 53 */
	t_u16 rsvdBit54:1;	/* bit 54 */
	t_u16 rsvdBit55:1;	/* bit 55 */
	t_u16 rsvdBit56:1;	/* bit 56 */
	t_u16 rsvdBit57:1;	/* bit 57 */
	t_u16 rsvdBit58:1;	/* bit 58 */
	t_u16 rsvdBit59:1;	/* bit 59 */
	t_u16 rsvdBit60:1;	/* bit 60 */
	t_u16 TDLSWildBandwidth:1;	/* bit 61 */
	t_u16 OperModeNtf:1;	/* bit 62 */
	t_u16 MaxAMSDU:2;	/* bit 63-bit 64 */
	t_u16 chanSchedMgnt:1;	/* bit 65 */
	t_u16 rsvdBit66:1;	/* bit 66 */
	t_u16 NCC:1;		/* bit 67 */
	t_u16 rsvdBit68:1;	/* bit 68 */
	t_u16 CAQ:1;		/* bit 69 */
	t_u16 FTMR:1;		/* bit 70 */
	t_u16 FTMI:1;		/* bit 71 */
	t_u16 FILS:1;		/* bit 72 */
	t_u16 rsvdBit73:1;	/* bit 73 */
	t_u16 rsvdBit74:1;	/* bit 74 */
	t_u16 rsvdBit75:1;	/* bit 75 */
	t_u16 rsvdBit76:1;	/* bit 76 */
	t_u16 rsvdBit77:1;	/* bit 77 */
	t_u16 rsvdBit78:1;	/* bit 78 */
	t_u16 rsvdBit79:1;	/* bit 79 */
} MLAN_PACK_END ExtCap_t, *pExtCap_t;
#endif
